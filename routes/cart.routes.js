...
module.exports = function(app){
    ...
    app.delete("/ecomm/api/v1/carts/:cartId",[authJwt.verifyToken] ,orderController.delete);

    app.put("/ecomm/api/v1/carts/:cartId/:status",[authJwt.verifyToken], orderController.changeCartStatus);
